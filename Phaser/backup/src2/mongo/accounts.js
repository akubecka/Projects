...
//const test = require("/Users/kubec/Desktop/Projects/Projects/Phaser/cs554_proj/public/images/banana.jpg")
...
const uploadNewPhoto = async function uploadNewPhoto(username, newPhoto){
	...
	gm('/Users/kubec/Desktop/Projects/Projects/Phaser/cs554_proj/public/images/banana.jpg')
		.resize(100,100)
		.write('banana2.jpg',function(err){
			if(err) console.log(err)
			console.log("conversion completed")
		})
